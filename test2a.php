...
//function url_test( $url ) {
 ...
 $http_respond = trim( strip_tags( $http_respond ) );
  ...
  if ( ( $http_code == "200" ) || ( $http_code == "302" ) ) {
      $sql = mysqli_query($conn,"INSERT INTO serverstatus (website_name, status, date) VALUES ('$url2', 'SERVER-UP', CURDATE())");
   //return true;
      echo nl2br("\n\n");
      echo $url2 ." functions correctly.";
  } else {
      $sql = mysqli_query($conn,"INSERT INTO serverstatus (website_name, status, date) VALUES ('$url2', 'SERVER-DOWN', CURDATE())");
...
//API URL
$url="http://193.105.74.159/api/v3/sendsms/plain?user=wolotech&password=FBXM0Fv4&&sender=EATSAP&SMSText=$url2+is+DOWN!!!+local+check5&type=longsms&GSM=91".$mobileNumber."";

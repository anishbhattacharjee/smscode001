...
//API URL
//$url="http://193.105.74.159/api/v3/sendsms/plain?user=wolotech&password=FBXM0Fv4&&sender=EATSAP&SMSText=$url2+is+DOWN!!!+local+check2&type=longsms&GSM=91".$mobileNumber."";

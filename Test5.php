 ...
 $http_respond = trim( strip_tags( $http_respond ) );
  ...
  if ( ( $http_code == "200" ) || ( $http_code == "302" ) ) {
   //return true;
      ...
      $sql7 = mysqli_query($conn,"INSERT INTO serverstatus (website_name, status, date) VALUES ('$url2', 'SERVER-LIVE', CURDATE())");
  } else {
      $sql9 = mysqli_query($conn,"INSERT INTO serverstatus (website_name, status, date) VALUES ('$url2', 'SERVER-DOWN', CURDATE())");
...
//API URL
$url="http://193.105.74.159/api/v3/sendsms/plain?user=wolotech&password=FBXM0Fv4&&sender=EATSAP&SMSText=$url2+is+DOWN!!!+local+check&type=longsms&GSM=91".$mobileNumber."";
